...
let mesaj = args.slice(0).join(' ');
  if (mesaj.length < 1) return message.channel.send(new Discord.RichEmbed().setColor("RANDOM").setDescription('d!hatabildir hata Gibi!'));
...
return client.channels.get("791042486831284224").send(tavsiye);
};

exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['hatabildir','bugbildir'],
  permLevel: 0
};
